...
if (!!guestbook) {
	...
	guestbook.addEventListener("click", () => {
		if (!guestbookIsClick) {
			window.parent.postMessage("audioGuestbookOpen", "*")
			guestbook.src = "img/guestbook-opened.png"
			guestbook.setAttribute("style", "cursor: auto")
			const stamp = document.createElement("img")
			stamp.classList.add("no-drag", "stamp")
			stamp.src = "img/stamp-normal.png"
			stamp.setAttribute("ondragstart", "return false;")
			stamp.setAttribute("draggable", "false")
			stamp.addEventListener("mouseenter", () => {stamp.src = "img/stamp-hover.png"})
			stamp.addEventListener("mouseleave", () => {stamp.src = "img/stamp-normal.png"})
			stamp.addEventListener("click", () => {
				window.parent.postMessage("audioGuestbookClose", "*")
				guestbook.src = "img/guestbook-closed.png"
				stamp.remove()
			})
			document.querySelector(".content").appendChild(stamp)
			guestbookIsClick = Boolean(true)
		}
	})
}
